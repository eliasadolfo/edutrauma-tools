...
es: {
  ...
  camas: {
    ...
    oUsaElEnlace: "¿El correo solo trae un enlace? Ábrelo: también entra, pero por el navegador.",
    ...
    trabajando: "Un momento…", yaEstaba: "Ya estaba en la evolución de {v}",
    guardarEnCama: "Guardar en la evolución de un paciente",
    guardarEnCamaSub: "Queda a la vista de tu equipo, con la hora real.",
    aQuePaciente: "¿A qué paciente?", aQuePacienteSub: "Se añadirá a su evolución, firmado por ti.",
    guardadoEn: "Añadido a la evolución de {v}",
    entregar: "Entregar", fmtShiftSub: "Con la firma de quién decidió cada cosa.",
    pendientesAlEntregar: "PENDIENTE:",
    egreso: "Dar de alta",
...
en: {
  ...
  camas: {
    ...
    oUsaElEnlace: "Only a link in the email? Open it: it also works, but through the browser.",
    ...
    trabajando: "One moment…", yaEstaba: "It was already in {v}'s notes",
    guardarEnCama: "Save to a patient's progress notes",
    guardarEnCamaSub: "Visible to your team, with the real time.",
    aQuePaciente: "Which patient?", aQuePacienteSub: "It will be added to their progress notes, signed by you.",
    guardadoEn: "Added to {v}'s progress notes",
    entregar: "Hand over", fmtShiftSub: "With the signature of who decided each thing.",
    pendientesAlEntregar: "PENDING:",
    egreso: "Discharge",
...
pt: {
  ...
  camas: {
    ...
    oUsaElEnlace: "O e-mail só trouxe um link? Abra: também entra, mas pelo navegador.",
    ...
    movido: "Paciente movido",
    trabajando: "Um momento…", yaEstaba: "Já estava na evolução de {v}",
    guardarEnCama: "Salvar na evolução de um paciente",
    guardarEnCamaSub: "Fica visível para sua equipe, com a hora real.",
    aQuePaciente: "Para qual paciente?", aQuePacienteSub: "Será adicionado à sua evolução, assinado por você.",
    guardadoEn: "Adicionado à evolução de {v}",
    entregar: "Passar plantão", fmtShiftSub: "Com a assinatura de quem decidiu cada coisa.",
    pendientesAlEntregar: "PENDENTE:",
    egreso: "Dar alta",
