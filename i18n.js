...
es: {
  ...
  camas: {
    ...
    enviando: "Enviando…",
    sinContrasena: "Sin contraseña. Te llega un enlace, lo tocas y estás dentro.",
    revisaCorreo: "Revisa tu correo",
    enviadoA: "Te enviamos un enlace a {v}. Ábrelo desde este mismo teléfono.",
...
en: {
  ...
  camas: {
    ...
    enviando: "Sending…",
    sinContrasena: "No password. You get a link, you tap it, you're in.",
    revisaCorreo: "Check your email",
    enviadoA: "We sent a link to {v}. Open it from this same phone.",
...
pt: {
  ...
  camas: {
    ...
    tuCorreo: "Seu e-mail",
    enviarEnlace: "Enviar um link",
    enviando: "Enviando…",
    sinContrasena: "Sem senha. Você recebe um link, toca nele e está dentro.",
    revisaCorreo: "Verifique seu e-mail",
    enviadoA: "Enviamos um link para {v}. Abra neste mesmo telefone.",
